...
import xyz.mastriel.cutapi.item.BasicCustomItem
...
abstract class SpellItem(id: Identifier, material: Material) : BasicCustomItem(id, material, CuTItemStack::class) {
}