...
import xyz.mastriel.cutapi.utils.serializers.LocationSerializer
import java.util.*
...
fun TagContainer.setLocation(key: String, value: Location? = null) =
    set(key, value, ObjectTagConverter(Location::class, LocationSerializer))

fun TagContainer.getLocation(key: String) =
    get(key, ObjectTagConverter(Location::class, LocationSerializer))

inline fun <reified T : Resource> TagContainer.setResourceRef(key: String, value: ResourceRef<T>? = null) =
    set(key, value, ResourceRefTagConverter<T>())

inline fun <reified T : Resource> TagContainer.getResourceRef(key: String) =
...
fun TagContainer.locationTag(key: String, default: Location) =
    objectTag(key, default, LocationSerializer)

fun TagContainer.nullableLocationTag(key: String, default: Location? = null) =
...
inline fun <reified T : Resource> TagContainer.refTag(key: String, default: ResourceRef<T>) =
    NotNullTag(key, this, default, ResourceRefTagConverter())

inline fun <reified T : Resource> TagContainer.nullableRefTag(key: String, default: ResourceRef<T>? = null) =
