...
inline fun <reified B: Behavior> BehaviorHolder<Behavior>.hasBehavior() = hasBehavior(B::class)
inline fun <reified B: Behavior> BehaviorHolder<Behavior>.getBehavior() = getBehavior(B::class)
inline fun <reified B: Behavior> BehaviorHolder<Behavior>.getBehaviorOrNull() = getBehaviorOrNull(B::class)
